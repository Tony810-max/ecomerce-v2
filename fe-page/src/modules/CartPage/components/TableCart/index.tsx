...
const TableCart = () => {
  ...
  const isLoading = cartContext?.isLoading;
      ...
      <TableBody>
        {isLoading ? (
          Array.from({ length: 5 }, (data, index) => (
            <TableRow key={index}>
              <TableCell>
                <Skeleton className="w-[50px] h-2 text-center" />
              </TableCell>
              <TableCell>
                <Skeleton className="w-full h-2 text-center" />
              </TableCell>
              <TableCell>
                <Skeleton className="w-full h-2 text-center" />
              </TableCell>
              ...
              <TableCell className="font-sans text-sm text-center">
                ...
                {(
                  (product?.product?.discount ??
                    product?.product?.priceOrigin) * quantities[index]
                ).toFixed(2)}
              </TableCell>
